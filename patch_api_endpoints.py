...
# Pattern for the duplicated validation code
...
# 1. Replace the duplicated check with a call to the helper function
content = duplicate_pattern.sub('        validate_allowed_path(source, root)\n', content)
